...
function PartsManager({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      onShowMessage(error instanceof Error ? error.message : 'Unable to save part.', 'error')
    } finally {
      setSubmitting(false)
    }
  }
  ...
  const handleDelete = async (part: Part) => {
    ...
    try {
      ...
      onShowMessage(error instanceof Error ? error.message : 'Unable to delete part.', 'error')
    }
  }
...
function VendorManager({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      onShowMessage(error instanceof Error ? error.message : 'Unable to save vendor.', 'error')
    } finally {
      setSubmitting(false)
    }
  }
  ...
  const handleDelete = async (vendor: Vendor) => {
    ...
    try {
      ...
      onShowMessage(error instanceof Error ? error.message : 'Unable to delete vendor.', 'error')
    }
  }
...
function PurchaseInvoiceManager({
  ...
  return (
    <section className="feature-section">
      ...
      <div className="stats-grid">
        <StatCard label="Invoices" value={String(invoices.length)} hint="Recorded stock purchases" />
        <StatCard label="Available Parts" value={String(parts.length)} hint="Usable in invoice items" />
        <StatCard
          label="Invoice Total"
